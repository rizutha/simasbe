    ...
    <div class="card">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input type="date" name="tglkeluar"
                            ...
                            placeholder="Masukkan Tgl. Keluar" value="{{ old('tglkeluar') }}">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <input type="text" name="tujuan"
                            ...
                            placeholder="Masukkan Tujuan Surat" value="{{ old('tujuan') }}">
        ...
        <div class="card-footer">
            <div class="my-2">
                ...
                <a href="{{route('suratkeluars.index')}}" class="btn btn-danger"><i class="fa fa-backward"></i>
                    Kembali</a>
            </div>
            </form>
        </div>
